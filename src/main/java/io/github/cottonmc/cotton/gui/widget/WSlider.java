...
public class WSlider extends WAbstractSlider {
    ...
    public static final ResourceLocation LIGHT_TEXTURE = new ResourceLocation(dustw.libgui.LibGui.MOD_ID, "textures/widget/slider_light.png");
    public static final ResourceLocation DARK_TEXTURE = new ResourceLocation(dustw.libgui.LibGui.MOD_ID, "textures/widget/slider_dark.png");
    ...
    public void paint(PoseStack matrices, int x, int y, int mouseX, int mouseY) {
        if (backgroundPainter != null) {
            ...
            int thumbXOffset;
            ResourceLocation texture = LibGui.isDarkMode() ? DARK_TEXTURE : LIGHT_TEXTURE;

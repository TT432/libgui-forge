...
public class WWidget {
    ...
    protected final ObservableProperty<Boolean> hovered = ObservableProperty.of(false).nonnull().name("WWidget.hovered").build();
     ...
     * {@link #paint(PoseStack, int, int, int, int) paint()} directly.
